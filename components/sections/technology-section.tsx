...
const sideImages = [
  {
    ...
    alt: "Member leading a warm-up at a club event",
    position: "left",
  },
  {
    src: "/images/prc-team.jpg",
    alt: "Patna Run Club members posing together",
    position: "right",
  },
];
      ...
      <div className="sticky top-0 h-[100dvh] overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              {/* Layered Images - Progressive Fade In through real club moments */}
              <Image
                src="/images/prc-group.jpg"
                alt="Patna Run Club group gathered together"
                fill
                className="object-cover"
                style={{
              ...
              <Image
                ...
                alt="Club members gathered at a Sunday event"
                fill
              ...
              <Image
                src="/images/prc-yoga-wide.jpg"
                alt="Members doing pranayama outdoors"
                fill
                className="absolute inset-0 object-cover"
                style={{
              ...
              <Image
                src="/images/prc-yoga-pranayama.jpg"
                alt="Rows of members in a breathing session"
                fill
                className="absolute inset-0 object-cover"
                style={{
