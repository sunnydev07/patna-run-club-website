...
const accessories = [
  {
    ...
    description: "5K / 10K from Shiv Puri Park, every Sunday at 6:00 AM",
    price: "Free",
    image: "/images/prc-group.jpg",
  },
  {
    id: 2,
    name: "Moonlight Zumba Run",
    description: "3K run plus an energetic Zumba session — music, groove, smile",
    price: "₹149",
    image: "/images/prc-warmup-girl.jpg",
  },
  {
    id: 3,
    name: "Patna Half Marathon",
    description: "21.1K through the city — Gandhi Maidan, 5:00 AM start",
    price: "₹149",
